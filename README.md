...
Auto Light application is using Android Notifications. However, actually there are no any notifications that applications need to display. For this reason you may disable Notifications manually in Android Settings.
